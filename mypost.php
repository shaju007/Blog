...
<body>
	...
	$result=mysql_query("SELECT * FROM content WHERE id='$user_id' ORDER BY uid DESC ",$connect);
	while($myrow=mysql_fetch_assoc($result)){?>
		...
		echo wordwrap($myrow['text1'],30,"<br>\n");
		echo "<br><a href=\"read_blog.php?uid=$myrow[uid]\">Read More...</a>
		|| <a href=\"edit_blog.php?uid=$myrow[uid]\">Edit</a>
		|| <a href=\"delete_blog.php?uid=$myrow[uid]\">Delete</a><br>";?>
